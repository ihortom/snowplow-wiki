...
$ java -jar snowplow-stream-collector-google-pusub-<VERSION>.jar --config <YOUR-CONFIG-FILE-NAME>
```
...
_ Under _Host and path rules_: you can just make sure that the backend service selected is the one
we just created
